...
async function renderMainPage() {
  ...
  function renderAccordion(title, content) {
    return `
      <div class="afinity-accordion-section">
        <button class="afinity-accordion-toggle">
          <span class="accordion-text">${title}</span>
          <span class="accordion-icon">+</span>
        </button>
        <div class="afinity-accordion">
          ${content}
        </div>
      </div>
    `;
  ...
  // helper: delivery/pickup section
  ...
  // helper: add extra meals section
  ...
  return `
    ...
    <div class="afinity-modal-content">
      ...
      ${renderAccordion("Frequency", renderFrequencySection())}
...
// Enhanced accordion toggle with auto-scroll and dynamic height
document.addEventListener("click", async function (e) {
  // ===== Accordion toggle logic (existing) =====
  ...
  if (toggle) {
    ...
    return; // prevent other handlers from running on accordion toggle clicks
  }

  // ===== Add Extra Meals button logic (NEW) =====
